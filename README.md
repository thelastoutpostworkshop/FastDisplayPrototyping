...
>ℹ️ Some graphical functions are not avalaible in Adafruit GFX, they are indicated in the table with the symbol ![GFX](https://img.shields.io/badge/Badge-blue)
